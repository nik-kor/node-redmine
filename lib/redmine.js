 ...
 *
 * Availalbe only from version 2.2
 */
Redmine.prototype.getEnumerations = function(params, callback) {
  if(params.type == 'time_entry_activities') {
    this.request('GET', '/enumerations/time_entry_activities.xml', {}, callback);
  }
};
